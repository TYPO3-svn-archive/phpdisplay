...
class ext_update {
	 ...
	 */
	function main() {
			// Get all phpdisplay records
		$templates = $GLOBALS['TYPO3_DB']->exec_SELECTgetRows('uid, title, template', 'tx_phpdisplay_displays', '', '', '', '', 'uid');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/phpdisplay/class.ext_update.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/phpdisplay/class.ext_update.php']);
}
?>
